...
- [파이썬 알고리즘 인터뷰](#파이썬-알고리즘-인터뷰)
  - [파이썬 알고리즘 인터뷰 깃허브](#깃허브)
  - [파이썬 알고리즘 인터뷰 유튜브](#유튜브)
  - [문제 풀이](#문제-풀이)
  - [3월 2일까지 진도](#진도표)
...
코딩 테스트 파이썬 알고리즘 인터뷰 깃허브사이트

- [깃허브](https://https://github.com/onlybooks/algorithm-interview)

## 유튜브

코딩 테스트 파이썬 알고리즘 인터뷰 유튜브사이트

- [유튜브](https://www.youtube.com/watch?v=fNyGHpSWhTA)

ReadMe Viewer Tip: You can also right-click on the editor Tab and select Open
Preview (⇧⌘V)
...
| 번호       | 제목                                                                                                                              | 난이도 | 장                            | 풀이 여부          |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------- | ------ | ----------------------------- | ------------------ |
| 1          | [유효한 팰린드롬](https://leetcode.com/problems/valid-palindrome/)                                                                | ★      | 6장. 문자열 조작              | :white_check_mark: |
| 2          | [문자열 뒤집기](https://leetcode.com/problems/reverse-string/)                                                                    | ★      | 6장. 문자열 조작              | :heavy_check_mark: |
...
| 19         | [역순 연결 리스트](https://leetcode.com/problems/reverse-linked-list/)                                                            | ★★     | 8장. 연결 리스트              |                    |
...
| 번호   | 제목                  | 문제수 | 진도 여부                |
| ------ | --------------------- | ------ | ------------------------ |
| 3장    | 파이썬                | 0문제  | :white_check_mark: - 3/3 |
| 4장    | 빅오 자료형           | 0문제  | :white_check_mark: - 3/4 |
| 5장    | 리스트, 딕셔너리      | 0문제  | :white_check_mark: - 3/5 |
| 6장    | 문자열 조작           | 6문제  | :heavy_check_mark:       |
| 7장    | 배열                  | 6문제  |                          |
| 8장    | 연결 리스트           | 7문제  |                          |
| 9장    | 스택, 큐              | 6문제  |                          |
| 10장   | 데크, 우선순위 큐     | 2문제  |                          |
